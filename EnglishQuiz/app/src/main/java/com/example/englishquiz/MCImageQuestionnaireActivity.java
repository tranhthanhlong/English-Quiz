...
import static com.example.englishquiz.LoginIntroActivity.imageList;
...
public class MCImageQuestionnaireActivity extends BaseActivity {

    CountDownTimer countDownTimer;
    RoundedHorizontalProgressBar progressBar;
    List<MCImageQuestions> allQuestionsList;
    MCImageQuestions mcImageQuestions;
    ImageView imageQuestion;
    TextView txtNumberOfQuestions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imagequestionnaire);
        ...
        allQuestionsList = imageList;
        Collections.shuffle(allQuestionsList);
        mcImageQuestions = imageList.get(index);
    ...
    private void setAllData() {
        Picasso.get().load(mcImageQuestions.getImage()).into(imageQuestion);
        ansA.setText(mcImageQuestions.getAnsA());
        ansB.setText(mcImageQuestions.getAnsB());
        ansC.setText(mcImageQuestions.getAnsC());
        ansD.setText(mcImageQuestions.getAnsD());
    ...
    private void Result() {
        ...
        batch.update(userDoc, "imagescore", score);
        batch.commit().addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                Intent intent = new Intent(MCImageQuestionnaireActivity.this, EnglishQuizResultActivity.class);
    ...
    public void OptionAClick(View view) {
        disableButton();
        if (mcImageQuestions.getAnsA().equals(mcImageQuestions.getAns()))
        {
            Correct(cvA);
        } else {
            Wrong(cvA);
    ...
    public void OptionBClick(View view) {
        disableButton();
        if (mcImageQuestions.getAnsB().equals(mcImageQuestions.getAns()))
        {
            Correct(cvB);
        } else {
            Wrong(cvB);
    ...
    public void OptionCClick(View view) {
        disableButton();
        if (mcImageQuestions.getAnsC().equals(mcImageQuestions.getAns()))
        {
            Correct(cvC);
        } else {
            Wrong(cvC);
    ...
    public void OptionDClick(View view) {
        disableButton();
        if (mcImageQuestions.getAnsD().equals(mcImageQuestions.getAns()))
        {
            Correct(cvD);
        } else {
            Wrong(cvD);
